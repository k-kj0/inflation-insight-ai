...
function _objectSpread$d(e) {
  for (var r2 = 1; r2 < arguments.length; r2++) {
    var t = null != arguments[r2] ? arguments[r2] : {};
    r2 % 2 ? ownKeys$d(Object(t), true).forEach(function(r22) {
      _defineProperty$h(e, r22, t[r22]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(t)) : ownKeys$d(Object(t)).forEach(function(r22) {
      Object.defineProperty(e, r22, Object.getOwnPropertyDescriptor(t, r22));
    });
  }
  return e;
...
function InflationChart({ data }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 340, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(ComposedChart, { data, margin: { top: 16, right: 12, left: -12, bottom: 0 }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("defs", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("linearGradient", { id: "ciFill", x1: "0", y1: "0", x2: "0", y2: "1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "0%", stopColor: "oklch(0.92 0.21 125)", stopOpacity: 0.25 }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "100%", stopColor: "oklch(0.92 0.21 125)", stopOpacity: 0.02 })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(CartesianGrid, { stroke: "oklch(1 0 0 / 8%)", strokeDasharray: "2 4", vertical: false }),
...
function StatCard({
  ...
  const valueColor = tone === "signal" ? "text-signal" : tone === "risk" ? "text-risk" : "text-foreground";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-md border border-border bg-surface-elevated p-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `mt-2 font-display text-3xl font-semibold ${valueColor}`, children: value }),
    hint && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-1 font-mono text-[10px] uppercase tracking-wider text-muted-foreground", children: hint })
  ] });
}
function PredictionStats({ current, predicted, delta, riskScore, volatility }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3 lg:grid-cols-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(StatCard, { label: "Current YoY", value: `${current.toFixed(2)}%`, hint: "last actual print" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      StatCard,
      {
        label: "Forecast",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-md border border-border bg-surface-elevated p-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-mono text-[10px] uppercase tracking-widest text-muted-foreground", children: "Δ Change" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          className: `mt-2 flex items-center gap-2 font-display text-3xl font-semibold ${deltaTone === "risk" ? "text-risk" : deltaTone === "signal" ? "text-signal" : "text-foreground"}`,
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: "h-6 w-6", strokeWidth: 2.4 }),
            delta > 0 ? "+" : "",
            delta.toFixed(2)
          ]
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-1 font-mono text-[10px] uppercase tracking-wider text-muted-foreground", children: "percentage points" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      StatCard,
      {
...
const analyzeInflation = createServerFn({
  ...
  return input;
}).handler(createSsrRpc("cc809242f2983b54882c1e9901d6fbce953c3ef42e351c22150d81f86577256a"));
const ACTION_TONE = {
...
function InfluxAIPanel(props) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "overflow-hidden rounded-lg border border-border bg-surface", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between border-b border-border bg-surface-elevated px-5 py-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "h-4 w-4 text-signal" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pulse-dot absolute -right-1 -top-1 h-1.5 w-1.5 rounded-full bg-signal" })
        ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-5", children: [
      !result && !loading && !error && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-start gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "max-w-xl text-sm text-muted-foreground", children: [
          ...
          " ·",
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-foreground", children: props.commodity }),
          " forecast."
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
      ...
      loading && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 py-8 text-muted-foreground", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "h-4 w-4 animate-spin text-signal" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-xs uppercase tracking-widest", children: "INFLUX AI is reasoning over the forecast…" })
      ] }),
      error && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3 rounded-md border border-risk/40 bg-risk/5 p-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(TriangleAlert, { className: "mt-0.5 h-4 w-4 flex-shrink-0 text-risk" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-mono text-[10px] uppercase tracking-widest text-risk", children: "Analysis halted" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-1 text-sm text-foreground", children: error }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              onClick: run,
      ...
      result && Action && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-mono text-[10px] uppercase tracking-widest text-signal", children: "Headline" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "mt-1.5 font-display text-2xl font-medium leading-tight text-balance", children: result.headline })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-mono text-[10px] uppercase tracking-widest text-muted-foreground", children: "Macro narrative" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1.5 text-sm leading-relaxed text-foreground/90", children: result.narrative })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid gap-5 md:grid-cols-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-mono text-[10px] uppercase tracking-widest text-muted-foreground", children: "Key risk factors" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "mt-2 space-y-1.5", children: result.riskFactors.map((r2, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex gap-2 text-sm text-foreground/90", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mt-1.5 h-1 w-1 flex-shrink-0 rounded-full bg-risk" }),
              r2
            ] }, i)) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-mono text-[10px] uppercase tracking-widest text-muted-foreground", children: "Business & consumer impact" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm leading-relaxed text-foreground/90", children: result.businessImpact })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-md border border-border bg-surface-elevated p-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-mono text-[10px] uppercase tracking-widest text-muted-foreground", children: "Investment signal" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `flex items-center gap-2 font-mono text-sm font-bold ${Action.color}`, children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Action.icon, { className: "h-4 w-4" }),
              result.investmentSignal.action
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-2 text-sm text-foreground/90", children: result.investmentSignal.rationale }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-3 flex flex-wrap gap-1.5", children: result.investmentSignal.instruments.map((inst) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            "span",
            {
...
const HISTORICAL = {
  US: [1.5, 1.4, 2.6, 5.4, 7, 9.1, 6.5, 3.7, 3.1, 2.4, 2.7, 2.9],
  EU: [1.3, 0.3, 1.9, 5, 8.6, 10.6, 8.6, 5.5, 2.4, 2, 2.2, 2.4],
  UK: [1.8, 0.7, 2.5, 5.4, 9.4, 11.1, 8.7, 4.6, 4, 2.3, 2, 2.6],
  JP: [0.5, -0.2, -0.2, 0.6, 2.4, 3.7, 4.3, 3.2, 2.5, 2.7, 2.2, 2.3],
  BR: [4.3, 4.5, 6.1, 10.7, 12.1, 11.9, 5.8, 4.7, 3.9, 4.5, 4.8, 4.2],
  IN: [3.7, 6.6, 5.5, 6.3, 7, 7.4, 5.7, 5.1, 4.8, 4.9, 5.5, 5.2],
  TR: [11.8, 12.3, 14.6, 19.6, 36.1, 64.3, 85.5, 64.8, 64.9, 75.4, 49.4, 45],
  AR: [53.8, 36.1, 50.9, 50.9, 64.1, 94.8, 211, 254, 287, 236, 166, 117]
};
const COMMODITY_BIAS = {
...
function seededRandom(seed) {
  let x2 = seed;
  return () => {
    x2 = (x2 * 9301 + 49297) % 233280;
    return x2 / 233280;
  };
}
function buildPrediction(country, commodity, horizonMonths) {
  ...
  const last2 = series[series.length - 1].actual;
  series[series.length - 1].forecast = last2;
  series[series.length - 1].upper = last2;
  series[series.length - 1].lower = last2;
  let cur = last2;
  ...
  const country_obj = COUNTRIES.find((c2) => c2.code === country);
  const commodity_obj = COMMODITIES.find((c2) => c2.id === commodity);
  return {
    series,
    current,
    predicted,
...
function Predictor() {
  ...
  const [commodity, setCommodity] = reactExports.useState("general");
  const [horizon, setHorizon] = reactExports.useState(12);
  const [used, setUsed] = reactExports.useState(0);
  ...
  const consumeCredit = () => {
    setUsed((u) => {
      ...
      try {
        const today = (/* @__PURE__ */ new Date()).toISOString().slice(0, 10);
        localStorage.setItem("iq-usage", JSON.stringify({
          date: today,
          used: next
        }));
      } catch {
  ...
  const prediction = reactExports.useMemo(() => buildPrediction(country, commodity, horizon), [country, commodity, horizon]);
  const remaining = Math.max(0, FREE_LIMIT - used);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(SiteHeader, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Ticker, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mx-auto max-w-7xl px-5 py-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-8 flex flex-col items-start justify-between gap-4 md:flex-row md:items-end", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-mono text-[11px] uppercase tracking-widest text-signal", children: "Predictor · v1" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "mt-2 font-display text-4xl font-medium tracking-tight md:text-5xl", children: [
            prediction.countryName,
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: " · " }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "italic", children: prediction.commodityLabel })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "mt-2 font-mono text-xs uppercase tracking-wider text-muted-foreground", children: [
            horizon,
            "-month forecast · bias: ",
            prediction.bias
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "rounded-md border border-border bg-surface px-3 py-2 font-mono text-[10px] uppercase tracking-widest", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: "Free tier · " }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: remaining > 0 ? "text-signal" : "text-risk", children: [
            remaining,
            "/",
            FREE_LIMIT,
            " analyses left"
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6 grid gap-3 rounded-lg border border-border bg-surface p-4 lg:grid-cols-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "mb-1.5 block font-mono text-[10px] uppercase tracking-widest text-muted-foreground", children: "Country" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1.5", children: COUNTRIES.map((c2) => /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => setCountry(c2.code), className: `rounded border px-2.5 py-1.5 font-mono text-[11px] transition-colors ${country === c2.code ? "border-signal bg-signal/10 text-signal" : "border-border bg-surface-elevated text-muted-foreground hover:text-foreground"}`, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mr-1", children: c2.flag }),
            c2.code
          ] }, c2.code)) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "mb-1.5 block font-mono text-[10px] uppercase tracking-widest text-muted-foreground", children: "Driver" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1.5", children: COMMODITIES.map((c2) => /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => setCommodity(c2.id), className: `rounded border px-2.5 py-1.5 font-mono text-[11px] transition-colors ${commodity === c2.id ? "border-signal bg-signal/10 text-signal" : "border-border bg-surface-elevated text-muted-foreground hover:text-foreground"}`, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "mr-1", children: c2.emoji }),
            c2.label
          ] }, c2.id)) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { className: "mb-1.5 block font-mono text-[10px] uppercase tracking-widest text-muted-foreground", children: [
            "Horizon · ",
            horizon,
            " months"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("input", { type: "range", min: 3, max: 24, step: 1, value: horizon, onChange: (e) => setHorizon(Number(e.target.value)), className: "mt-3 w-full accent-signal" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-1 flex justify-between font-mono text-[10px] text-muted-foreground", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "3mo" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "24mo" })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(PredictionStats, { current: prediction.current, predicted: prediction.predicted, delta: prediction.delta, riskScore: prediction.riskScore, volatility: prediction.volatility }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-6 rounded-lg border border-border bg-surface p-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-3 flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-mono text-[10px] uppercase tracking-widest text-muted-foreground", children: "YoY % · historical + forecast" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-0.5 font-display text-lg", children: "Inflation curve" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4 font-mono text-[10px] uppercase tracking-widest text-muted-foreground", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "h-0.5 w-4 bg-foreground" }),
              " actual"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "h-0.5 w-4 bg-signal", style: {
                backgroundImage: "repeating-linear-gradient(90deg, var(--signal) 0 4px, transparent 4px 8px)"
              } }),
              "forecast"
            ] })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(InflationChart, { data: prediction.series })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(InfluxAIPanel, { country: prediction.countryName, commodity: prediction.commodityLabel, horizon, current: prediction.current, predicted: prediction.predicted, delta: prediction.delta, riskScore: prediction.riskScore, volatility: prediction.volatility, remaining, onConsumeCredit: consumeCredit }) })
    ] })
  ] });
}
export {
  Predictor as component
};
