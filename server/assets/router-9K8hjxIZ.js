...
const appCss = "/assets/styles-BwaBPyJF.css";
...
const Route$4 = createRootRoute({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "AI-powered inflation forecasts and investment signals, powered by Claude."
      },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Fraunces:ital,opsz,wght@0,9..144,400;0,9..144,500;0,9..144,600;1,9..144,400;1,9..144,500&family=Inter:wght@400;500;600;700&family=JetBrains+Mono:wght@400;500;600&display=swap"
      }
    ]
  }),
...
const $$splitComponentImporter$3 = () => import("./pricing-IJSHsizt.js");
const Route$3 = createFileRoute("/pricing")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Free tier: 3 AI analyses/day. Pro $29/mo: unlimited + portfolio impact. Business: API access for fintech apps."
    }, {
      property: "og:title",
      content: "InflationIQ Pricing"
    }, {
...
const $$splitComponentImporter$2 = () => import("./predictor-vAQ4x3HL.js");
const Route$2 = createFileRoute("/predictor")({
  head: () => ({
    meta: [{
      title: "Predictor — InflationIQ"
    }, {
      name: "description",
      content: "Generate AI inflation forecasts by country and commodity. Get risk analysis and investment signals in seconds."
    }, {
      property: "og:title",
      content: "InflationIQ Predictor"
    }, {
      property: "og:description",
      content: "Real Claude-powered inflation analysis: pick a country, pick a commodity, ship a signal."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./api-BRCA8T9t.js");
const Route$1 = createFileRoute("/api")({
  head: () => ({
    meta: [{
      title: "API — InflationIQ"
    }, {
      name: "description",
      content: "REST API for fintech apps. Embed InflationIQ forecasts and Claude-powered analysis into your product."
    }, {
      property: "og:title",
      content: "InflationIQ API"
    }, {
      property: "og:description",
...
const $$splitComponentImporter = () => import("./index-CIWNzkof.js");
const Route2 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "AI-powered inflation forecasts, risk analysis, and investment signals. Powered by Claude. Free for individuals, API for fintech."
    }, {
      property: "og:title",
      content: "InflationIQ — Economic intelligence, on demand"
    }, {
      property: "og:description",
      content: "Forecast inflation by country and commodity. Get a real Claude-powered analysis with risk narrative and investment signal in seconds."
    }]
  }),
...
const PredictorRoute = Route$2.update({
  id: "/predictor",
  path: "/predictor",
  getParentRoute: () => Route$4
});
const ApiRoute = Route$1.update({
  id: "/api",
  path: "/api",
  getParentRoute: () => Route$4
});
